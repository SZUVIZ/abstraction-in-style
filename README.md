...
### [Paper](https://arxiv.org/abs/2603.29924) | [Project Page](https://chapai24.github.io/AiS_gh_pages/)
...
By default, `--stage all` and `--stage A-VAT` read from `test_assets/input_images/`, while `--stage S-VAT` reads from `test_assets/generated_images/A-VAT_outputs/`. You can also use `--input-dir` to specify a different input directory explicitly.
